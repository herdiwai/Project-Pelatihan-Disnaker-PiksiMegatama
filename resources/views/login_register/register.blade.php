        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-6 offset-xl-3">
                ...
                @csrf
                  <div class="row">
                    <div class="form-group col-12">
                      ...
                      <input id="first_name" name="name" type="text" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" autofocus>
            ...
            <div class="simple-footer">
              Pelatihan-Piksi-Megatama By <strong>Herdi</strong> Nov-2020
            </div>
          </div>
        </div>
